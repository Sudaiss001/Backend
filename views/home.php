   <!-- Why choose
            ...
            <div class="row g-4 banner style-2 justify-content-center">
              <div class="col-12 col-sm-6 text-center">
                <div class="item rounded shadow d-inline-block"> <a href="#">
                  ...
                  <img class="img-fluid" src="<?= $server_name ?>/assets/images/anyone-freelancer.jpg" width="410" height="350"  alt="banner"> </a> </div>
              </div>
              <div class="col-12 col-sm-6 text-center">
                <div class="item rounded shadow d-inline-block"> <a href="#">
                  <div class="caption rounded-bottom">
                  ...
                  <div class="banner-mask"></div>
                  <img class="img-fluid" src="<?= $server_name ?>/assets/images/anyone-online-shopping.jpg" width="410" height="350"  alt="banner"> </a> </div>
              </div>
              <div class="col-12 col-sm-6 mb-sm-0 text-center">
                <div class="item rounded shadow d-inline-block"> <a href="#">
                  ...
                  <div class="banner-mask"></div>
                  <img class="img-fluid" src="<?= $server_name ?>/assets/images/anyone-online-sellers.jpg" width="410" height="350"  alt="banner"> </a> </div>
              </div>
              <div class="col-12 col-sm-6 text-center">
                <div class="item rounded shadow d-inline-block"> <a href="#">
                  <div class="caption rounded-bottom">
                  ...
                  <div class="banner-mask"></div>
                  <img class="img-fluid" src="<?= $server_name ?>/assets/images/anyone-affiliate-marketing.jpg" width="410" height="350" alt="banner"> </a> </div>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="section">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="card bg-dark-3 shadow-sm border-0"> <img class="card-img img-fluid opacity-8" src="<?= $server_name ?>/assets/images/how-work.jpg" width="570" height="362"  alt="banner">
              <div class="card-img-overlay p-0"> <a class="d-flex h-100 video-btn" href="#" data-src="<?= $server_name ?>/assets/https://www.youtube.com/embed/7e90gBu4pas" data-bs-toggle="modal" data-bs-target="#videoModal"> <span class="playButton playButton-pulsing bg-white m-auto"><i class="fas fa-play"></i></span> </a> </div>
            </div>
          </div>
    ...
    <section class="section py-5">
      <div class="container">
        <div class="justify-content-center text-center">
          ...
          <a class="d-inline-flex mx-3" href=""><img alt="" width="168" height="49"  src="<?= $server_name ?>/assets/images/app-store.png"></a> <a class="d-inline-flex mx-3" href=""><img alt="" width="166" height="49"  src="<?= $server_name ?>/assets/images/google-play-store.png"></a>
		</div>
      </div>
    </section>
    <!-- Mobile App end --> 
